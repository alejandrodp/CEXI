/**
 * @brief The class which controls the window to show up the info of the virtual pages.
 * 
 * @file MemoryViewer.h
 * @author aleklnx
 * @date 2018-04-17
...
private:
    ...
    /**
     * @brief Set the total memory of all pages together in GUI.
     * 
     * @param page The pointer of list with all pages.
     */
